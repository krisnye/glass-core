(function() {
    ...
    var Expression = this;
    var value; //  assigned during _init_
    ...
    var _parser = this._parser = {
            ...
            function parse_root() {
                ...
                if (result0 === null) {
                    ...
                    if (result0 === null) {
                        ...
                        if (result0 !== null) {
                            result0 = (function(offset, a) {
                                return [expr("ancestor", [Math.max(0, a.length - 1)])];
                            })(pos0, result0);
                        }
                        if (result0 === null) {
                            pos = pos0;
                        ...
                        if (result0 === null) {
                            pos0 = pos;
                            result0 = parse_rootOrStep();
                            if (result0 !== null) {
                                result0 = (function(offset, a) {
                                    return [expr("ancestor", [0]), a];
                                })(pos0, result0);
                            }
                            if (result0 === null) {
                                pos = pos0;
         ...
         */
            ...
            function unaryRight(ops, e, map) {
                while (ops.length > 0) {
                    op = ops.pop();
                    if (map.hasOwnProperty(op)) op = map[op];
                    if (op != null) e = expr(op, [e]);
                }
                return e;
            }
