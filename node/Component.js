...
(function() {
  var Component, assert, extend, generateId, getBaseDefiningClass, getUnderrideName, glass_Component, isPrimitive, properties, underride;
  ...
  Component.normalizeProperties = function(properties, definingClass) {
    ...
    for (name in properties) {
      ...
      if (definingClass != null) {
        if ((_ref = property.definingClass) == null) {
  ...
  properties = {
    ...
    initialize: function(properties) {
      ...
      parent[id] = this;
      return (_ref1 = this.glass_Component_subclass_initialize) != null ? _ref1.call(this) : void 0;
    },
    dispose: function() {
      var _ref;
      ...
      if (this._parent != null) {
        ...
        this._parent = null;
        if ((_ref = this.glass_Component_subclass_dispose) != null) {
          _ref.call(this);
        }
      }
    },
